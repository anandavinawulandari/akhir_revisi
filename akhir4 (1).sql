...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 03 Agu 2023 pada 05.10
...
('A1', '9871', 'C14', 'C21', 'C31', 'C41', 'C52', '2023-05-30 01:36:58', '2023-06-19 14:24:30', 1, 4, 4, 4, 3),
('A10', '9880', 'C11', 'C22', 'C31', 'C41', 'C52', '2023-04-23 22:08:52', '2023-06-02 02:53:21', 4, 3, 4, 4, 3),
('A11', '9867', 'C12', 'C23', 'C32', 'C42', 'C52', '2023-07-10 06:51:30', '2023-07-10 06:51:30', 3, 2, 3, 3, 3),
('A12', '9899', 'C14', 'C22', 'C32', 'C42', 'C52', '2023-07-10 06:50:43', '2023-07-10 06:50:43', 1, 3, 3, 3, 3),
('A14', '9878', 'C12', 'C23', 'C31', 'C42', 'C51', '2023-07-09 19:22:52', '2023-07-09 19:36:19', 3, 2, 4, 3, 4),
('A2', '9872', 'C14', 'C23', 'C31', 'C42', 'C53', '2023-04-23 22:06:58', '2023-04-23 22:06:58', 1, 2, 4, 3, 2),
('A3', '9873', 'C11', 'C22', 'C32', 'C42', 'C51', '2023-04-23 22:07:10', '2023-04-23 22:07:10', 4, 3, 3, 3, 4),
('A4', '9874', 'C13', 'C21', 'C31', 'C41', 'C53', '2023-04-23 22:07:23', '2023-04-23 22:07:23', 2, 4, 4, 4, 2),
('A5', '9875', 'C12', 'C22', 'C31', 'C43', 'C52', '2023-04-23 22:07:33', '2023-04-23 22:07:33', 3, 3, 4, 2, 3),
('A6', '9876', 'C14', 'C24', 'C32', 'C44', 'C51', '2023-04-23 22:07:43', '2023-06-08 14:36:16', 1, 1, 3, 1, 4),
('A7', '9877', 'C12', 'C22', 'C31', 'C42', 'C52', '2023-04-23 22:07:58', '2023-04-23 22:07:58', 3, 3, 4, 3, 3),
('A9', '9887', 'C12', 'C23', 'C31', 'C42', 'C51', '2023-06-08 14:18:29', '2023-06-08 14:18:29', 3, 2, 4, 3, 4);
...
CREATE TABLE `hasil` (
  ...
  `bobotc1` double DEFAULT NULL,
  `bobotc2` double DEFAULT NULL,
  `bobotc3` double DEFAULT NULL,
  `bobotc4` double DEFAULT NULL,
  `bobotc5` double DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
INSERT INTO `hasil` (`kode_hasil`, `kode_alternatif`, `nis`, `kode_kriteria`, `kode_subkriteria`, `nilai_rangking`, `status`, `created_at`, `updated_at`, `c1`, `c2`, `c3`, `c4`, `c5`, `bobotc1`, `bobotc2`, `bobotc3`, `bobotc4`, `bobotc5`) VALUES
(47, 'A1', '9871', NULL, NULL, 73.75, '', '2023-07-07 09:55:18', '2023-07-11 22:13:41', 0.25, 1, 0.75, 1, 0.75, 6.25, 25, 15, 20, 7.5),
(48, 'A10', '9880', NULL, NULL, 86.25, 'LOLOS', '2023-07-07 09:55:18', '2023-07-07 09:56:01', 1, 0.75, 0.75, 1, 0.75, 25, 18.75, 15, 20, 7.5),
(49, 'A2', '9872', NULL, NULL, 53.75, 'TIDAK LOLOS', '2023-07-07 09:55:18', '2023-07-07 09:58:15', 0.25, 0.5, 0.75, 0.75, 0.5, 6.25, 12.5, 15, 15, 5),
(50, 'A3', '9873', NULL, NULL, 88.75, 'LOLOS', '2023-07-07 09:55:18', '2023-07-07 09:55:53', 1, 0.75, 1, 0.75, 1, 25, 18.75, 20, 15, 10),
(51, 'A4', '9874', NULL, NULL, 77.5, 'LOLOS', '2023-07-07 09:55:18', '2023-07-07 09:56:16', 0.5, 1, 0.75, 1, 0.5, 12.5, 25, 15, 20, 5),
(52, 'A5', '9875', NULL, NULL, 70, 'LOLOS', '2023-07-07 09:55:18', '2023-07-07 09:58:05', 0.75, 0.75, 0.75, 0.5, 0.75, 18.75, 18.75, 15, 10, 7.5),
(53, 'A6', '9876', NULL, NULL, 47.5, 'TIDAK LOLOS', '2023-07-07 09:55:18', '2023-07-07 09:58:24', 0.25, 0.25, 1, 0.25, 1, 6.25, 6.25, 20, 5, 10),
(54, 'A7', '9877', NULL, NULL, 75, 'LOLOS', '2023-07-07 09:55:18', '2023-07-18 20:26:16', 0.75, 0.75, 0.75, 0.75, 0.75, 18.75, 18.75, 15, 15, 7.5),
(56, 'A9', '9887', NULL, NULL, 71.25, 'LOLOS', '2023-07-07 09:55:18', '2023-07-07 09:57:58', 0.75, 0.5, 0.75, 0.75, 1, 18.75, 12.5, 15, 15, 10),
(58, 'A14', '9878', NULL, NULL, 71.25, 'LOLOS', '2023-07-09 19:23:31', '2023-07-09 19:36:35', 0.75, 0.5, 0.75, 0.75, 1, 18.75, 12.5, 15, 15, 10),
(59, 'A11', '9867', NULL, NULL, 91.6667, 'LOLOS', '2023-07-10 06:51:37', '2023-08-02 20:07:15', 1, 0.66666666666667, 1, 1, 1, 25, 16.666666666667, 20, 20, 10),
(60, 'A12', '9899', NULL, NULL, 83.3333, 'LOLOS', '2023-07-10 06:51:37', '2023-08-02 20:07:15', 0.33333333333333, 1, 1, 1, 1, 8.3333333333333, 25, 20, 20, 10);
...
('9867', 'Robi Fastio', 'L', '2023-07-10', 'Kediri', '1A', '085655394431', 'C52', 'C32', 'C23', 'C42', 'C12', '2021/2022', 'kk_1688996806.png', '2023-07-10 06:46:46', '2023-07-10 06:46:46'),
...
('9899', 'Adinda Yuniar', 'P', '2023-07-10', 'Kunjang', '2D', '085655394431', 'C52', 'C32', 'C22', 'C42', 'C14', '2021/2022', 'kk_1688997000.png', '2023-07-10 06:50:00', '2023-07-10 06:50:00');
...
CREATE TABLE `users` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deskripsipassword` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
(29, 'admin', 'adminsmp@gmail.com', NULL, '$2y$10$WahXYRqylLMcm8WzCYrFeu4YNyGDPKIJUxHTxkG1oEK2x6GfntEbm', 'admin', '9', NULL, '2023-05-27 20:49:58', '2023-05-27 20:49:58', 'admin123'),
...
(41, 'Adinda Yuniar', 'adindayuni@gmail.com', NULL, '$2y$10$jGUlr9wWZ1NskCulGIeSxuaoIA1WpeTM.jKs0/aXeEnl2A9ithtEG', 'pesdik', '9899', NULL, '2023-06-09 08:06:36', '2023-06-09 08:06:36', 'adinda9899'),
(42, 'ananda', 'anandavina@gmail.com', NULL, '$2y$10$rVY1TGRtZh7fP4M15/E/LOEtq8N9n9HgSxGurhhYTnhyfb/320XeS', 'pesdik', '12', NULL, '2023-07-09 19:16:59', '2023-07-09 19:16:59', 'ananda');
...
--
ALTER TABLE `hasil`
  MODIFY `kode_hasil` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;

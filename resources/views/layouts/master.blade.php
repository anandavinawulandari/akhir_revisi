    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- @if (Auth::check() && Auth::user()->level == 'pesdik')
            <li class="nav-item">
            <a href="{{url('/home2')}}" class="nav-link">
          ...
          @if (Auth::check() && Auth::user()->level == 'admin')
            <li class="nav-item">
            <a href="{{route('auth.opsi')}}" class="nav-link">
          ...
          @if (Auth::check() && Auth::user()->level == 'pesdik')
            <li class="nav-item">
            <a href="{{route('pesdik.create')}}" class="nav-link">
              <i class="nav-icon fas fa-table"></i>
              <p>
                Pendaftaran
                <!-- <i class="fas fa-angle-left right"></i> -->
          ...
          @if (Auth::check() && Auth::user()->level == 'pesdik')
            ...
            <!-- @if (Auth::check() && Auth::user()->level == 'admin') -->
            <li class="nav-item">
            <a href="{{route('hasil.index3')}}" class="nav-link">
              <i class="nav-icon fas fa fa-bullhorn"></i>
              <p>
                Validasi
                <!-- <i class="right fas fa-angle-left"></i> -->
...
<div class="card">
        <div class="card-header bg-dark text-white">
          <b class="card-title "> {{ Auth::user()->name }}</b>

    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          @if (Auth::check() && Auth::user()->level == 'pesdik')
          <li class="nav-item">
            <a href="{{route('pesdik.index3')}}" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Data Pendaftaran
                <span class="right badge badge-danger">New</span>
          ...
          @if (Auth::check() && Auth::user()->level == 'pesdik')
            <li class="nav-item">
            <a href="{{route('hasil.index2')}}" class="nav-link">
              <i class="nav-icon fas fa-table"></i>
              <p>
                Data Seleksi
                <!-- <i class="fas fa-angle-left right"></i> -->
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="small-box bg-success">
              <div class="inner">
                <h3>CONTACT US<sup style="font-size: 20px"></sup></h3>

                <p>Telepon  :   (0354) 393127</p>
                <p>Alamat   :   Jl Raya Kunjang - Badas No 263, Desa Kuwik Kec. Kunjang Kab. Kediri</p>
                <p>Website  :   <u>http://www.smpn2kunjangkabkediri.sch.id</u></p>
                <p>Email    :   info@smpn2kunjangkabkediri.sch.id</p>
            </div>
              <div class="icon">

      ...
      <div class="row ">
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                {{-- <a href="{{route('hasil.create')}}" class="btn btn-success pull-right">+ Submit Data</a> --}}
                    ...
                    <table class="table table-bordered table-striped" id="example2">
                        ...
                        <tbody>
                            ...
                            <td style="text-align: center"> {{ $loop->iteration }}</td>
                                ...
                                <!-- <td style="text-align: center"><a href="{{ route('hasil.edit', $data->kode_hasil)}}" class="badge btn btn-warning mx-1 border-0">Edit</a></td> -->

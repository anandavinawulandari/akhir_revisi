...
@if(Session::has('sucess'))
    <div class="alert alert-success alert-block">
      ...
      <div class="row ">
        ...
        <!-- <br><br>
                <h4>Data Pembobotan Alternatif</h4>
                    ...
                    <thead>
                        ...
                        <tbody>
                            @foreach ($dataAlternatif as $data => $value)
                            <tr>
                                <td style="text-align: center"> {{ $loop->iteration }}</td>
                                <td style="text-align: center"> {{ $value->kode_alternatif }}</td>
                                <td style="text-align: center"> {{ $value->nis }}</td>
                                <td style="text-align: center"> {{ $value->nama }}</td>
                                <td style="text-align: center"> {{ $value->bobot_riwayat }}</td>
                                <td style="text-align: center"> {{ $value->bobot_pekerjaan }}</td>
                                <td style="text-align: center"> {{ $value->bobot_penghasilan }}</td>
                                <td style="text-align: center"> {{ $value->bobot_jml_tanggungan }}</td>
                                <td style="text-align: center"> {{ $value->bobot_nilai }}</td>
                            </tr>
                            @endforeach
                        </tbody>              
                    </table> -->

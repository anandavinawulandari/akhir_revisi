                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center"> {{ $data->nis }}</td>
                                 ...
                                 <a href="{{ route('pesdik.destroy', $data->nis)}}" class="badge btn btn-danger mx-1 border-0" onClick="return confirm('Yakin Hapus Data?')">Hapus</a> 
                                     <a href="{{ url('/pesdik/'. $data->nis .'/view') }}">
